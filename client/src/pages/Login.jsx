  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-md bg-white bg-opacity-90 backdrop-blur-md rounded-2xl shadow-lg p-8 mx-4">
        ...
        <h2 className="text-center text-3xl font-extrabold mb-2 text-gradient bg-clip-text text-transparent bg-gradient-to-r from-green-600 to-teal-600">Welcome back</h2>
        <p className="text-center text-gray-700 mb-6">Sign in to continue your eco journey</p>
